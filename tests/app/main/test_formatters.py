...
@pytest.mark.parametrize('status, notification_type, expected', (
    ...
    ('temporary-failure', 'email', partial(url_for, 'main.messages_status', _anchor='email-statuses')),
    ('permanent-failure', 'email', partial(url_for, 'main.messages_status', _anchor='email-statuses')),
    ('technical-failure', 'email', partial(url_for, 'main.messages_status', _anchor='email-statuses')),
    ('temporary-failure', 'sms', partial(url_for, 'main.messages_status', _anchor='sms-statuses')),
    ('permanent-failure', 'sms', partial(url_for, 'main.messages_status', _anchor='sms-statuses')),
    ('technical-failure', 'sms', partial(url_for, 'main.messages_status', _anchor='sms-statuses')),
