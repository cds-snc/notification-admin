...
class TestAssetFingerprint(object):
    def test_url_format(self, mocker):
        get_file_content_mock = mocker.patch.object(
            AssetFingerprinter, "get_asset_file_contents"
        )
    ...
    def test_s3_url(self):
        ...
        assert (
            fingerprinter.get_s3_url("foo.png")
            == "https://assets.example.com/static/foo.png"
        )
