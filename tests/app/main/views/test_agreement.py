...
@pytest.mark.parametrize(
    "agreement_signed, crown, expected_links",
    [
        (
            True,
            True,
...
def test_show_accept_agreement_page(
    ...
    assert normalize_spaces(page.select_one("label[for=version] + span#version-hint").text) == (
