...
@pytest.mark.parametrize(
    ...
    [
        (
            'Templates – service one – GC Notify',
            'Templates',
            [],
            {},
        ...
        (
            'folder_one – Templates – service one –  GC Notify',
        ...
        (
            'folder_one_one – folder_one – Templates – service one – GC Notify',
        ...
        (
            'folder_one_one_one – folder_one_one – folder_one – Templates – service one – GC Notify',
        ...
        (
            'folder_two – Templates – service one – GC Notify',
