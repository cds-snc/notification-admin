...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("sms", "provider-failure", "DESTINATION_COUNTRY_BLOCKED", "Can't send to this international number 16:31:00", False),
        ("sms", "provider-failure", "NO_ORIGINATION_IDENTITIES_FOUND", "Can't send to this international number 16:31:00", False),
