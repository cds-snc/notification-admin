...
def test_email_branding_page_shows_full_branding_list(
    platform_admin_client, mock_get_all_email_branding
):
    ...
    assert page.select_one("#create_email_branding")["href"] == url_for(
...
def test_edit_email_branding_shows_the_correct_branding_info(
    platform_admin_client, mock_get_email_branding, fake_uuid
):
...
def test_create_email_branding_does_not_show_any_branding_info(
    platform_admin_client, mock_no_email_branding
):
...
def test_create_new_email_branding_without_logo(
    ...
    platform_admin_client.post(
        url_for(".create_email_branding"), content_type="multipart/form-data", data=data
    )
...
def test_deletes_previous_temp_logo_after_uploading_logo(
    ...
    platform_admin_client.post(
        url_for(
            "main.create_email_branding", logo=temp_old_filename, branding_id=fake_uuid
        ),
