...
let Components = {
    ...
    Panel: () => cy.getByTestId('attachments-panel'),
    Modal: () => cy.getByTestId('attachments-panel'),
    ...
    PendingList: () => cy.getByTestId('pending-files-list'),
    ValidationErrors: () => cy.getByTestId('attach-validation-errors'),
    PendingRowSpinner: () => cy.getByTestId('pending-files-list').find('[data-testid="attachment-row-spinner"]'),
