...
describe("Mobile menu", () => {
  ...
  it("Open and close the menu using ESC and clicking", () => {
    ...
    MainMenu.Components.MenuItems().then((menuItems) => { // first menu item should be focused
  ...
  it("Navigate the menu forward using right arrow, down arrow", () => {
    ...
    MainMenu.ArrowRight();
    MainMenu.Components.MenuItems().then((menuItems) => { // second menu item should be focused
