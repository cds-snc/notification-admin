    ...
    return createPortal(
        ...
        >
            <div
                ref={dialogRef}
                tabIndex="-1"
                className="bg-white w-[95%] max-w-[720px] mx-auto mt-16 p-8 border border-gray-300 shadow-lg text-base"
            >
                ...
                <ul class="list list-bullet ml-5">
                    ...
                    <li>
                        {copy.modalTextDocuments}
                    </li>
                    <li>
                        {copy.modalDataDocuments}
                    </li>
                    <li>
                        {copy.modalImageDocuments}
                    </li>
                </ul>
