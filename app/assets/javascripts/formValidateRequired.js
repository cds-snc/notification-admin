...
(function () {
    ...
    function _validateRequired(id) {
      let error_html = (id, error) => `<span id="${id}-error-message" data-testid="${id}-error" class="error-message" data-module="track-error" data-error-type="${error}" data-error-label="${id}">${error}</span>`;
