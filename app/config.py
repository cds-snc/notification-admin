...
class Config(object):
    ...
    # Disable access to "API integration" for some service IDs.
    # The constant should contain a comma separated list
    # of service UUIDs.
    API_DISABLED_SERVICE_IDS = os.getenv("API_DISABLED_SERVICE_IDS", "")
