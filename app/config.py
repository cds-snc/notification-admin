...
class Config(object):
    ...
    SALESFORCE_ENGAGEMENT_PRODUCT_ID = os.environ.get("SALESFORCE_ENGAGEMENT_PRODUCT_ID")
    SALESFORCE_ENGAGEMENT_RECORD_TYPE = os.environ.get("SALESFORCE_ENGAGEMENT_RECORD_TYPE")
    SALESFORCE_ENGAGEMENT_STANDARD_PRICEBOOK_ID = os.environ.get("SALESFORCE_ENGAGEMENT_STANDARD_PRICEBOOK_ID")    
