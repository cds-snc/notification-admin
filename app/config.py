...
if os.environ.get("VCAP_APPLICATION"):
    # on cloudfoundry, config is a json blob in VCAP_APPLICATION
    # unpack it, and populate standard environment variables from it
...
class Config(object):
    ...
    BLOCKED_SIGNUP_EMAIL_DOMAINS = (
        os.getenv("BLOCKED_SIGNUP_EMAIL_DOMAINS", "").split(",") if os.getenv("BLOCKED_SIGNUP_EMAIL_DOMAINS") else ["parl.gc.ca"]
    )
