...
def features_email():
    return render_template("views/emails.html", navigation_links=features_nav())


@main.route("/sms", endpoint="sms")
def features_sms():
    return render_template("views/text-messages.html", navigation_links=features_nav())


@main.route("/letters", endpoint="letters")
def features_letters():
    return render_template("views/letters.html", navigation_links=features_nav())


@main.route("/templates", endpoint="templates")
def features_templates():
    return render_template("views/templates.html", navigation_links=features_nav())
