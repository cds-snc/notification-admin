...
def create_temporary_sample_template(template_id: str, current_user_id, preview=False) -> Dict[str, Any]:
    """
    ...
    new_template_data["subject"] = template_data.get("example_subject", "") if preview else template_data.get("subject", "")
