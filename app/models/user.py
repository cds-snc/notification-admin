...
class User(JSONModel, UserMixin):
    ...
    def send_branding_request(self, serviceID, service_name, org_id, org_name, filename):
        user_api_client.send_branding_request(self.id, serviceID, service_name, org_id, org_name, filename)
